...
const Fl = "/ecom-demo/assets/image-product-1.0c6fe8e3.jpg",
  jl = "/ecom-demo/assets/icon-minus.7f289c13.svg",
  Nl = "/ecom-demo/assets/icon-plus.fd8d372c.svg",
  Ll = "/ecom-demo/assets/icon-cart-w.8b7f6b34.svg",
  Lr = "/ecom-demo/assets/logo.5efe6b0e.svg",
  kr = "/ecom-demo/assets/icon-cart.987a9f06.svg",
  Rr = "/ecom-demo/assets/image-product-1-thumbnail.4e7f5e07.jpg",
  Br = "/ecom-demo/assets/icon-delete.11e8f9c5.svg",
  Hr = "/ecom-demo/assets/image-avatar.88751761.png",
  It = (e, t) => {
...
const yc = It(lc, [["render", vc]]),
  xc = "/ecom-demo/assets/icon-menu.cd0a0bcb.svg",
  Cc = {
    data() {
      return {
        menuItems: ["Collections", "Men", "Women", "About", "Contact"],
...
const Nc = It(Cc, [["render", jc]]),
  nn = "/ecom-demo/assets/icon-next.de5dbcf9.svg",
  Lc = { class: "mt-4" },
  kc = { class: "relative" },
  Rc = ["src"],
  ...
  Kc = {
    data() {
      return {
        mainImage: [
          "/ecom-demo/assets/image-product-1.jpg",
          "/ecom-demo/assets/image-product-2.jpg",
          "/ecom-demo/assets/image-product-3.jpg",
          "/ecom-demo/assets/image-product-4.jpg",
        ],
        currentSrc: 0,
      };
    },
        ...
        galleryItems: [
          {
            ...
            source: "/ecom-demo/assets/image-product-1-thumbnail.jpg",
          },
          {
            title: "Product Thumb 2",
            source: "/ecom-demo/assets/image-product-2-thumbnail.jpg",
          },
          {
            title: "Product Thumb 3",
            source: "/ecom-demo/assets/image-product-3-thumbnail.jpg",
          },
          {
            title: "Product Thumb 4",
            source: "/ecom-demo/assets/image-product-4-thumbnail.jpg",
          },
        ],
      };
    },
  ...
  Dr = "/ecom-demo/assets/icon-close.22a11be2.svg",
  vu = {
    data() {
      return {
        showModal: !1,
